...
class AuthViewModel(private val repository: AuthRepository) : ViewModel() {
    ...
    private val _registerResult = MutableLiveData<ResultAuth<RegisterResponseDTO>>()
    val registerResult: LiveData<ResultAuth<RegisterResponseDTO>> = _registerResult
    ...
    fun register(name: String, phone: String, address: String, password: String) {
        viewModelScope.launch {
            _registerResult.value = ResultAuth.Loading
